...
class DepartmentCoupleController extends Controller
{
    protected $departmentCoupleRepository;

    public function __construct(DepartmentCoupleRepository $departmentCoupleRepository)
    {
